...
VALUES 
('love_bunny', '사랑스러운 강아지 입양합니다', '건강한 강아지를 입양할 분을 찾습니다. 관심 있으시면 연락 주세요.', '입양', '서울시 강남구', '강아지', '소형견', '/images/dog1.jpg', '2025-05-12 10:30:00', 120, 진행중),
('cat_lovers', '고양이 분양합니다', '귀여운 고양이가 새로운 집을 찾고 있습니다. 입양을 원하시면 연락 주세요.', '분양', '서울시 서초구', '고양이', '단모종', '/images/cat1.jpg', '2025-05-11 14:00:00', 45, 진행중),
('dog_lover_88', '다정한 고양이 입양해 주세요', '이 고양이는 아주 사람을 좋아합니다. 입양을 원하시면 연락주세요.', '입양', '서울시 마포구', '고양이', '장모종', '/images/cat2.jpg', '2025-05-10 18:45:00', 58, 대기중),
('happy_pet_owner', '튼튼한 강아지 분양합니다', '튼튼하고 건강한 강아지를 분양합니다. 소형견을 원하시는 분 연락 주세요.', '분양', '경기도 성남시', '강아지', '소형견', '/images/dog2.jpg', '2025-05-09 08:20:00', 62, 완료),
('kitten_fanatic', '기다리고 있는 입양 고양이', '따뜻한 집을 기다리고 있는 귀여운 고양이입니다. 관심 있으신 분들은 연락 주세요.', '입양', '서울시 용산구', '고양이', '단모종', '/images/cat3.jpg', '2025-05-08 11:30:00', 30, 완료),
('paw_hero', '귀여운 강아지 입양합니다', '이 강아지는 정말 착하고 사람을 좋아해요. 입양할 분을 기다립니다.', '입양', '서울시 송파구', '강아지', '중형견', '/images/dog3.jpg', '2025-05-07 15:00:00', 85, 완료),
('pet_paradise', '모든 종류의 고양이 입양 중', '우리는 다양한 고양이를 입양 중입니다. 원하는 고양이를 찾아보세요.', '입양', '경기도 고양시', '고양이', '다양한 품종', '/images/cat4.jpg', '2025-05-06 17:00:00', 110, 완료),
('four_legged_friend', '강아지 분양합니다', '건강한 강아지를 분양합니다. 관심 있으시면 바로 연락 주세요!', '분양', '인천시 부평구', '강아지', '소형견', '/images/dog4.jpg', '2025-05-05 09:40:00', 95, 대기중),
('pets_adore', '귀여운 고양이 입양해 주세요', '이 고양이는 굉장히 활발하고 귀여워요. 따뜻한 집을 찾아요.', '입양', '서울시 동대문구', '고양이', '단모종', '/images/cat5.jpg', '2025-05-04 13:20:00', 76, 진행중),
('lovely_pet', '분양할 귀여운 강아지', '사랑스러운 강아지가 새로운 집을 찾고 있습니다. 연락 주세요!', '분양', '경기도 화성시', '강아지', '중형견', '/images/dog5.jpg', '2025-05-03 11:10:00', 42, 완료),
('meow_pals', '입양할 고양이들', '저희 집에는 여러 고양이가 있습니다. 입양을 원하시면 연락 주세요.', '입양', '서울시 강동구', '고양이', '소형묘', '/images/cat6.jpg', '2025-05-02 14:50:00', 60, 완료),
('doggy_lover', '튼튼한 강아지 분양합니다', '귀엽고 건강한 강아지를 찾고 있습니다. 관심 있으면 연락 주세요!', '분양', '서울시 영등포구', '강아지', '대형견', '/images/dog6.jpg', '2025-05-01 10:00:00', 108, 완료),
('kitten_queen', '사랑스러운 고양이 입양 중', '사람을 매우 좋아하는 고양이입니다. 따뜻한 집을 기다리고 있어요.', '입양', '서울시 강서구', '고양이', '단모종', '/images/cat7.jpg', '2025-04-30 12:40:00', 50, 완료),
('paws_and_claws', '강아지와 고양이 입양합니다', '강아지와 고양이를 동시에 입양하실 분을 찾습니다. 관심 있으면 연락 주세요.', '입양', '부산시 해운대구', '강아지', '소형견', '/images/dog7.jpg', '2025-04-29 16:30:00', 38, 완료),
('tail_waggers', '분양할 강아지들', '튼튼하고 건강한 강아지를 분양합니다. 집을 찾고 있어요.', '분양', '서울시 노원구', '강아지', '대형견', '/images/dog8.jpg', '2025-04-28 11:15:00', 120, 완료);
COMMIT;
