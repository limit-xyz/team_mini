...
<div class="row my-5" id="global-content">
	<div class="col">
		...
		<form name="dictionaryUpdateForm" action="dictionaryUpdateProcess?pageNum=${pageNum}" id="dictionaryUpdateForm" class="row g-3 border-primary" 
			method="post" enctype="multipart/form-data">

			<input type="hidden" name="no" value="${dictionary.no}">
			<input type="hidden" name="memberId" value="${sessionScope.id}">
			<input type="hidden" name="pageNum" value="${pageNum}">
			
			<div class="col-8 offset-md-2">
			    <label for="title" class="form-label">제 목</label>
			    <input type="text" class="form-control" name="title"  id="title"  value="${dictionary.title}">
	  		</div>
	  		
	  		<div class="col-8 offset-md-2">
			    <label for="petName" class="form-label">누구의 다이어리를 작성하시나요?</label>
			    <input type="text" class="form-control" name="petName"  id="petName" value="${dictionary.petName}"
