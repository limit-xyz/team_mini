...
<div class="row my-5" id="global-content">
	<div class="col">
		...
		<form action="dictionaryWriteProcess?pageNum=${pageNum}&type=cat" id="dictionaryWriteForm"  class="row g-3 border-primary"
			method="post" enctype="multipart/form-data">
	  		...
	  		<div class="col-4">
			    ...
			    <input type="radio" name="breedType" value="장묘종" checked>장묘종
			    <input type="radio" name="breedType" value="단묘종">단묘종
			    <input type="radio" name="breedType" value="소형묘">소형묘
	  		</div>
	  		...
	  		<div class="col-4">
			    ...
			    <input type="radio" name="independence" value="낮음" checked>낮음
			    <input type="radio" name="independence" value="중간">중간
			    <input type="radio" name="independence" value="높음">높음
	  		</div>
	  		...
	  		<div class="col-4">
			    ...
			    <input type="radio" name="affectionLevel" value="낮음" checked>낮음
			    <input type="radio" name="affectionLevel" value="중간">중간
			    <input type="radio" name="affectionLevel" value="높음">높음
	  		</div>
	  		...
	  		<div class="col-4">
			    ...
			    <input type="radio" name="activityLevel" value="낮음" checked>낮음
			    <input type="radio" name="activityLevel" value="중간">중간
			    <input type="radio" name="activityLevel" value="높음">높음
	  		</div>
	  		

 			<div class="col-4 offset-md-2">
			    <label for="vocality" class="form-label">울음소리 빈도/크기</label><br>	
			    <input type="radio" name="vocality" value="높음" checked>높음
			    <input type="radio" name="vocality" value="중간">중간
			    <input type="radio" name="vocality" value="낮음">낮음
	  		</div>
 			...
 			<div class="col-4 offset-md-2">
			    ...
			    <input type="radio" name="sheddingLevel" value="높음" checked>높음
			    <input type="radio" name="sheddingLevel" value="중간">중간
			    <input type="radio" name="sheddingLevel" value="낮음">낮음
	  		</div>

 			<div class="col-4">
			    <label for="hypoallergenic" class="form-label">알러지 저자극성 여부</label><br>	
			    <input type="radio" name="hypoallergenic" value="Y" checked>Y
			    <input type="radio" name="hypoallergenic" value="N">N
	  		</div>
		
			 <div class="col-4 offset-md-2">
			    <label for="compatibilityWithKids" class="form-label">아이들과의 친화력</label><br>	
			    <input type="radio" name="compatibilityWithKids" value="높음" checked>높음
			    <input type="radio" name="compatibilityWithKids" value="중간">중간
			    <input type="radio" name="compatibilityWithKids" value="낮음">낮음
	  		</div>
