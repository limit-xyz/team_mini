...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<div class="row my-5" id="global-content">
			<div class="col">		
				...
				<form name="searchForm" id="searchForm" action="${pageContext.request.contextPath}/free/boardList" method="post"
				...
				<div class="row">
					<div class="col">
						<a href="${pageContext.request.contextPath}/free/boardList" class="btn btn-outline-success">리스트</a>
					</div>
					<div class="col text-end">
						<a href="${pageContext.request.contextPath}/free/writeForm" class="btn btn-outline-success">글쓰기</a>
					</div>
				</div>				
				</c:if>
				<%-- 검색 요청이 아닌 경우  --%>
						...
						<table class="table table-hover">
							...
							<c:forEach var="board" items="${ bList }">
								<tr>
									...
									<td class="text-secondary">
										<a href="${pageContext.request.contextPath}/free/freeDetail?no=${board.no}&pageNum=${currentPage}&type=${type}&keyword=${keyword}" 
							...
							<c:forEach var="board" items="${ bList }">
								<tr>
									<td>${board.no}</td> 
									<td class="text-secondary">
										<a href="${pageContext.request.contextPath}/free/freeDetail?no=${board.no}&pageNum=${currentPage}" 
										class="text-secondary text-decoration-none">${board.title}</a>
										</td>
									<td class="text-secondary">${board.writer}</td>
									<td>${board.regDate}</td>
